...
$BODY$
 ...
 BEGIN
      ...
      INSERT INTO txn_usertracking (userid,latitude,longitude,createddate)
      SELECT userid,latitude,longitude,now() FROM json_populate_record(null::txn_usertracking, locationjson::json)
 ...
 $BODY$
  ...
  COST 100;
ALTER FUNCTION public.saveLocation(text)
  OWNER TO "Watook";
