					  ...
					  <div class="container-fluid">
						...
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						  ...
						  <ul class="nav navbar-nav navbar-right">
							...
							<li><a href="#works">PRIVACY POLICY</a></li>
							<li><a href="#clients">COMMITMENTS</a></li>
							<li><a href="#joinus">TERMS OF SERVICES</a></li>
				...
				<div class="main_banner_area">
					<div class="col-md-6 col-sm-6">
						<div class="single_banner wow fadeIn">
							<img src="images/Watook_logo.png" alt="" />
						</div>
					</div>
					<div class="col-md-6 col-sm-6">
						<div class="single_banner_text wow zoomIn" data-wow-duration="1s">
							<h2>Watook</h2>
							<p>Watook is a dating app. </p>
